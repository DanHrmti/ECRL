...
from slot_attention.data import PandaPushDataModule
...
def main(params=None):
    ...
    datamodule = PandaPushDataModule(
    ...
    logger = pl_loggers.WandbLogger(project=f'{params.model_type}-{params.dataset}')
